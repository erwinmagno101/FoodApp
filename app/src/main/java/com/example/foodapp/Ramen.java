...
public class Ramen extends Fragment implements View.OnClickListener {


    View view;
    String ID;
    DBHelper DB;
    Button rambtnAdd, rambtnAdd2, rambtnAdd3, rambtnBack;
    TextView ramtxtItemName, ramtxtItemName2, ramtxtItemName3;
    TextView ramtxtItemPrize, ramtxtItemPrize2, ramtxtItemPrize3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_ramen, container, false);
        ID = LogInSection.ID;
        DB = new DBHelper(getContext());
        rambtnAdd = view.findViewById(R.id.rambtnAdd);
        rambtnAdd.setOnClickListener(this);
        rambtnAdd2 = view.findViewById(R.id.rambtnAdd2);
        rambtnAdd2.setOnClickListener(this);
        rambtnAdd3 = view.findViewById(R.id.rambtnAdd3);
        rambtnAdd3.setOnClickListener(this);
        rambtnBack = view.findViewById(R.id.rambtnBack);
        rambtnBack.setOnClickListener(this);
        ramtxtItemName = view.findViewById(R.id.ramtxtItemName);
        ramtxtItemName2 = view.findViewById(R.id.ramtxtItemName2);
        ramtxtItemName3 = view.findViewById(R.id.ramtxtItemName3);
        ramtxtItemPrize = view.findViewById(R.id.ramtxtItemPrice);
        ramtxtItemPrize2 = view.findViewById(R.id.ramtxtItemPrice2);
        ramtxtItemPrize3 = view.findViewById(R.id.ramtxtItemPrice3);

        item1 = new Item("Tonkotsu Ramen", 350);
        ramtxtItemName.setText(item1.getItemName());
        ramtxtItemPrize.setText("₱ " + Integer.toString(item1.getPrice()));
        item2 = new Item("Chicken Ramen", 300);
        ramtxtItemName2.setText(item2.getItemName());
        ramtxtItemPrize2.setText("₱ " + Integer.toString(item2.getPrice()));
        item3 = new Item("Shoyu Ramen", 250);
        ramtxtItemName3.setText(item3.getItemName());
        ramtxtItemPrize3.setText("₱ " + Integer.toString(item3.getPrice()));
        return view;
    }
