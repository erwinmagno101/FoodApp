...
public class Pizza extends Fragment implements View.OnClickListener {
    ...
    String ID;
    DBHelper DB;
    Button pizbtnAdd, pizbtnAdd2, pizbtnAdd3, pizbtnBack;
    TextView piztxtItemName, piztxtItemName2, piztxtItemName3;
    TextView piztxtItemPrize, piztxtItemPrize2, piztxtItemPrize3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pizbtnAdd = view.findViewById(R.id.pizbtnAdd);
        pizbtnAdd.setOnClickListener(this);
        pizbtnAdd2 = view.findViewById(R.id.pizbtnAdd2);
        pizbtnAdd2.setOnClickListener(this);
        pizbtnAdd3 = view.findViewById(R.id.pizbtnAdd3);
        pizbtnAdd3.setOnClickListener(this);
        pizbtnBack = view.findViewById(R.id.pizbtnBack);
        pizbtnBack.setOnClickListener(this);
        piztxtItemName = view.findViewById(R.id.piztxtItemName);
        piztxtItemName2 = view.findViewById(R.id.piztxtItemName2);
        piztxtItemName3 = view.findViewById(R.id.piztxtItemName3);
        piztxtItemPrize = view.findViewById(R.id.piztxtItemPrice);
        piztxtItemPrize2 = view.findViewById(R.id.piztxtItemPrice2);
        piztxtItemPrize3 = view.findViewById(R.id.piztxtItemPrice3);

        item1 = new Item("Spicy Chicken Pizza", 260);
        piztxtItemName.setText(item1.getItemName());
        piztxtItemPrize.setText("₱ " + Integer.toString(item1.getPrice()));
        item2 = new Item("Pepperoni Pizza", 250);
        piztxtItemName2.setText(item2.getItemName());
        piztxtItemPrize2.setText("₱ " + Integer.toString(item2.getPrice()));
        item3 = new Item("Veggie Overload", 300);
        piztxtItemName3.setText(item3.getItemName());
        piztxtItemPrize3.setText("₱ " + Integer.toString(item3.getPrice()));
        return view;
    }
